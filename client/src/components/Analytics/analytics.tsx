    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          {prediction && (
            <div className="mt-4">
              <h3 className="text-lg font-semibold">Predicted Productivity Score: {prediction.productivityScore}</h3>
              <h4 className="text-md font-semibold mt-2">Suggested Tasks for Next Week:</h4>
